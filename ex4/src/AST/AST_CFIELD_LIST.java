...
public class AST_CFIELD_LIST extends AST_Node
{
	...
	public TYPE_CLASS_VAR_DEC_LIST SemantMe() throws semanticExc {
		...
		while(it != null){
			...
			reverse_type_list = new TYPE_CLASS_VAR_DEC_LIST(new TYPE_CLASS_VAR_DEC(((TYPE_CLASS_VAR_DEC)fieldType).t, it.first.name), reverse_type_list);
			it = it.restoflist;
	...
	public TEMP_LIST IRme(){
		...
		for(AST_CFIELD_LIST it=this;it!=null;it=it.restoflist){
