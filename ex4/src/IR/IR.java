...
public class IR
{
	...
	public TEMP wordSizeTemp = new TEMP(MIPSGenerator.WORD_SIZE, true);
	public TEMP sp;
	public TEMP fp;
	public TEMP ra;
	public TEMP v0;
...
//	public static PrintStream fileWriter = System.out;
	...
	*/
	...
	public void MIPSme()
	{
		MIPSGenerator.getInstance().dataSection();
		if (dataHead != null) dataHead.MIPSme();
		if (dataTail != null) dataTail.MIPSme();
		MIPSGenerator.getInstance().textSection();
		if (head != null) head.MIPSme();
		if (tail != null) tail.MIPSme();
		MIPSGenerator.getInstance().finalizeTextSection();
	}
	public void printMe(){
